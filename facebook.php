...
<body>
	<table width="100%">
		...
		<td> &emsp; &nbsp; &emsp; &emsp;&emsp;&emsp;&emsp;&emsp;&emsp; <b>facebook</b>
			...
			<div >
				<img class="img-read" src="Images/read.png"><p class="text-read"><b>See photos and updates</b>&nbsp; form friends in News Feed.</p>
				<img class="img-timeline" src="Images/timeline.png"><p class="text-timeline"><b>Share what's new</b>&nbsp; in your life in Timeline.</p>
				<img class="img-search" src="Images/search.png"><p class="text-search"><b>Find more</b>&nbsp; of what you are looking for with Facebook Search.</p>
			</div>
